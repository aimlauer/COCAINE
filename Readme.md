...
Clave: service2 
```
Se te va a reiniciar el módem y vas a tener que volver a configurar toda tu WiFi de nuevo si es que te conectás por WiFi si estás por cable seguí las instrucciones de abajo para terminar de configurarlo,
